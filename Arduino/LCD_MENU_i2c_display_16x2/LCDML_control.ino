...
// *********************************************************************
  ...
  #define encoder_B_pin       8    // physical pin has to be 2 or 3 to use interrupts (on mega e.g. 20 or 21), use internal pullups
  #define encoder_button_pin  7    // physical pin , use internal pullup
